...
| [`cypherpoet-session-harvest`](https://github.com/CypherPoet/custom-agent-skills/tree/main/plugins/cypherpoet-session-harvest) | Run a pre-exit sweep of a conversation for learnings worth preserving, routing each to its right home: a memory, or a suggested repo edit (CLAUDE.md/AGENTS.md, docs, or a hook) |
